...
const Page = (props) => {
  ...
  const [columns, setColumns] = useState([
    ...
    },
    {
      ...
      key: "listActive",
      title: "Холбоотой цэснүүдийг жагсаалтаар харуулах",
      status: false,
      filterMode: "tree",
      filters: [
        {
          text: "Жагсаалтаар харуулах",
          value: "true",
        },
        {
          text: "Жагсаалтаар харуулахгүй",
          value: "false",
        },
      ],
      sorter: (a, b) => handleSort(),
  ...
  const exportExcel = async () => {
    ...
    if (response) {
      ...
      excelData = data.map((el) => {
        ...
        el.createUser = el.createUser && el.createUser.firstname;
        el.updateUser = el.updateUser && el.updateUser.firstname;
        el.menu = el.menu && el.menu.length > 0 && el.menu.map((el) => el.name);
